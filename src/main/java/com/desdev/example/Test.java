 ...
 */
public class Test extends JFrame implements Runnable, WebcamPanel.Painter {
    ...
    public Test() throws IOException {
        ...
        troll = ImageIO.read(Objects.requireNonNull(getClass().getResourceAsStream("/troll-face.png")));
    ...
    public void run() {
        while (true) {
            ...
            FImage createdImage = ImageUtilities.createFImage(webcam.getImage());
            faces = detector.detectFaces(createdImage);
        }
    }
